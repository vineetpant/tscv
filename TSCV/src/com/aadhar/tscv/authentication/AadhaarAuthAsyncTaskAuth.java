...
import com.aadhar.tscv.authentication.AadhaarAuthAsyncTaskKyc.TrustAllCertsSSLSocketFactory;
import com.aadhar.tscv.events.ServerResponse;
import com.aadhar.tscv.util.GsonSerializerUtil;


public class AadhaarAuthAsyncTaskAuth extends AsyncTask<String, Void, AuthResponse> {
	...
	public AadhaarAuthAsyncTaskAuth(Context ctx, AuthCaptureData authCaptureData) {
