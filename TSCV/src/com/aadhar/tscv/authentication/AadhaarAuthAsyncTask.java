...
public class AadhaarAuthAsyncTask extends AsyncTask<String, Void, KycResponse> {
	...
	public AadhaarAuthAsyncTask(Context ctx, KycCaptureData authCaptureData) {
	...
	protected void onPostExecute(KycResponse response) {
		...
		String msg = "Auth Status: " + (response.isSuccess() ? "success" : "fail")
		        ...
		        + " " + response.getKyc().getPoi().getName();
