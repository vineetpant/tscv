...
import com.social.dial.database.DbCallLog;
import com.social.dial.database.DbContacts;
import com.social.dial.database.DbSmsLog;
...
public class DatabaseClass extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME="contactsDatabaseSocialDial";
    ...
    public static DatabaseClass getInstance(){
        if(dbManager==null)
            dbManager=new DatabaseClass(MyApplication.getAppContext());
        return dbManager;
    }
    ...
    public void addTenant(Tenant tenant){
        ...
        getInstance().db.insert("tenant", null, contentValues);
    }
    ...
    public Tenant getTenantByUID(String uid) {
        ...
        contentValues.setPhoto(cursor.getString(6));
        cursor.close();
    ...
    public void addOwner(Owner owner) {
        ...
        getInstance().db.insert("owner", null, contentValues);
    }
    ...
    public void addPoliceStation(PoliceStation policeStation) {
        ...
        getInstance().db.insert("police_station", null, contentValues);
    }
    ...
    public void addServentHistory(ServentHistory serventHistory){
        ...
        getInstance().db.insert("servent_history", null, contentValues);
    }
    ...
    public ArrayList<ServentHistory> getServentHistoryByServentId(String servant_id) {
        ...
        cursor.moveToFirst();
        ArrayList<ServentHistory> list = new ArrayList<>();
        do {
